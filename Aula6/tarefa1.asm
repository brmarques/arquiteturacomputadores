...
main:
	...
	add	$t5, $t0, $0		# guarda valor de $t1 para comparação
	addi	$t2, $t0, 1		# = 5
	add 	$t3, $t0, $t2		# = 4+5
repeat:					#inicia o loop
	...
	beq	$t5, $t1, finally	# if t0  = t5 então finaliza o programa
	add 	$t3, $t3, $t2		# = 4+5
	blt	$t5, $t1, repeat	# if t0 (inicialmente 2 ++) <= t5 (7) então refaz o loop		
