...
repeat:	
	beq 	$t1, $t3, equal		#branch on equal - compara se são iguais; i == limite, repete = label para o laço de repetição
	add 	$t2, $t2, $t3		#acc = acc + i
	addi 	$t3, $t3, 1		#i = i + 1
	j repeat			#salta para o laço condicional "repeat"
	
equal: 	
	add 	$t2, $t2, $t3		#se o valor nos registradores for iguais, realiza a instrução nesse label
